...
import ArizaIcon from '../../components/assets/images/google-docs.png'
import KirishIcon from '../../components/assets/images/shield.png'
import RegisterIcon from '../../components/assets/images/verify.png'
				...
				<div className='flex justify-between items-center'>
					...
					<div className='flex gap-3 items-center'>
						<div className='flex gap-3 items-center'>
							...
							>
								<Link
									href={'/ariza-topshirish'}
									className='flex gap-2 items-center'
								>
									<Image src={ArizaIcon} alt='Icon' width={20} height={20} />
									<p>Ariza topshirish</p>
								</Link>
							</div>
							<SignedOut>
								<div
